...
A2bar= 1;
k2=1.1;
m=0.5;% Go to classical_Sym_gen.m and choose the appropriate initial guess for the classical case
n=1.5;

% Initial guesses for resonant cases
A11_guess = 1.05;
A12_guess = A11_guess;
guess_Ro0oS = [0.2894    0.0338    0.1168    0.1672];
guess_Ro0oR = [0.2894    0.0338    0.1168    0.1672];
guess_RoSS = [0.1867    0.7037];
guess_RoSR = [0.3867    0.7528 ];
